		...
		var cdTool = function(container, map, app, configFile){
			...
			this.showIntro = function(){
					...
					this.continueButton = new Button({
						label: "Continue",
						id: "cd_continueBtn",
						onClick: function(){self.geoSelect(this)}
					});
					
					var continueButtonDiv  = domConstruct.create("div", {id:"cd_continueButtonDiv", style: "text-align: center; position: relative; top: -10px;"});
					this.introPanel.appendChild(continueButtonDiv);
					continueButtonDiv.appendChild(this.continueButton.domNode);
			...
			this.geoSelect = function(){
				...
				this.geoSelectDiv = domConstruct.create("div", {id:"cd_geoSelectDiv", innerHTML: "To begin, select region:<br/><br/>", style: "margin: 10px;"});
			...
			this.createProfilePlot = function(){
				...
				var xTitle = 'Distance From Mean Sea Level (MSL) ' //+ this.currentUnits.unitText;
				var yTitle = 'Depth (' + this.currentUnits.unitTextFull + ' from MSL)';
				axisFonts = '14pt';
...
// 					domStyle.set(sliderBar, "background-color", "rgba(148, 175, 0, 0.4)!important");
			...
			this.plotResults = function(){
				...
				var yTitle = "Percent of Original (100 - 0)" //'Percent of No Habitat Scenario';
